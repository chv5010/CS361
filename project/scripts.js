...
let wordData = ['KITTEN', 'BEAVER', 'MONEY', 'OREGON', 'UTAH', 'FUNNY', 'QUEEN', 'CAMPING', 'ROWDY', 'SWINGER']
let word = 0;
let wordScramble = 0;
let wordLength = 0;
...
function getRequest(callback) {
    let baseUrl = 'http://flip3.engr.oregonstate.edu:5152/amount/1/length/';
...
// function to start the game and use dom manipulation to build the board

function startGame() {
    getRequest(function(word) {
